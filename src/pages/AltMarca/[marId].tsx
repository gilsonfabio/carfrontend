...
const AltMarca = () => {
    ...
    const [idMar, setIdMarca] = useState(router.query.marId); 
    ...
    useEffect(() => {    
      ...
      api({
        ...
        setDescricao(response.data[0].marDescricao);
